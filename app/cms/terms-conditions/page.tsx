...
export default function CMSTermsConditionsPage() {
  const { t } = useLanguage()
    ...
    const fetchData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            bannerTitleEn: data.bannerTitleEn || 'Terms & Conditions',
            bannerTitleId: data.bannerTitleId || 'Syarat & Ketentuan',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast({ title: 'Saved', description: 'Terms & Conditions updated successfully.' })
      } else {
    ...
    <div className="space-y-6 mt-4 flex flex-col h-full">
      ...
      <div>
        <h1 className="text-2xl font-bold text-foreground">
          {t({ en: 'Terms & Conditions', id: 'Syarat & Ketentuan' })}
        </h1>
        <p className="text-muted-foreground text-sm mt-1">
          {t({ en: 'Manage the Terms & Conditions page content', id: 'Kelola konten halaman Syarat & Ketentuan' })}
        </p>
      </div>
            ...
            <Card className="p-6 space-y-6">
              <div className="space-y-2">
                <Label htmlFor="bannerTitleEn">
                  {t({ en: 'Banner Title (English)', id: 'Judul Banner (Inggris)' })}
                </Label>
                <Input
                  id="bannerTitleEn"
            ...
            <Card className="p-6 space-y-6">
              <div className="space-y-2">
                <Label htmlFor="bannerTitleId">
                  {t({ en: 'Page Title (Indonesian)', id: 'Judul Halaman (Indonesia)' })}
                </Label>
                <Input
                  id="bannerTitleId"
