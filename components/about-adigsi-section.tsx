...
export function AboutAdigsiSection() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const aboutRes = await fetch('/api/cms/about/about')
  ...
  return (
    <section ref={sectionRef} className="w-full max-w-310uto px-4 md:px-8 lg:px-32.75 pt-20">
...
export function PartnersSection() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const partnersRes = await fetch('/api/cms/about/partners')
